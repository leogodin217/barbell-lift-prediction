...
### Summary 
This project aims to predict quality of barbell lifts using data from a fitness tracker. In this study, we analyzed various movements from the fitness trackers using random forests to determine correctness of the exercise. Data for this project can be found her: http://groupware.les.inf.puc-rio.br/har. 
...
```
### Conclusion
With this new model, we've lowered our error rate to `r 1 - results$overall[1]`. We predict similar error rates for the test data. After submitting the test results, we acheived 0% errors and have concluded that this model gives a good prediction 
